...
class SkyRoverInterface:
    ...
    def __init__(self):
        if SkyRoverInterface._is_initialized:
            return

        carb.log_info("Initializing the SkyRover Simulator Extension")
        SkyRoverInterface._is_initialized = True
    ...
    def __new__(cls):
        ...
        return SkyRoverInterface._instance

    def __del__(self):
        SkyRoverInterface._instance = None
        SkyRoverInterface._is_initialized = False