...
class PX4MavlinkBackendConfig(BackendConfig):
    ...
    def __init__(self, vehicle_id: int = 0, config_file: str = None):
        ...
        self.set("vehicle_id", vehicle_id)
...
class PX4MavlinkBackend(Backend):
    ...
    def __init__(self, config: PX4MavlinkBackendConfig = PX4MavlinkBackendConfig()):
        ...
        self._vehicle_id = self.config.get("vehicle_id")
        self._connection = None
        self._connection_port = (
            self.config.get("connection_type")
            + ":"
        ...
        self.px4_autolaunch: bool = self.config.get("px4_autolaunch")
        self.px4_vehicle_model: str = self.config.get("px4_vehicle_model")  # only needed if px4_autolaunch == True
        ...
        self._rotor_data: ThrusterControl = ThrusterControl(
            self.config.get("num_rotors"), 
            self.config.get("input_offset"), 
            self.config.get("input_scaling"), 
            self.config.get("zero_position_armed")
        )

        # Vehicle actuator control data
        self._num_inputs: int = self.config.get("num_rotors")
        ...
        self._enable_lockstep: bool = self.config.get("enable_lockstep")
    ...
    def update(self, dt):
        ...
        if self.config.get("send_ground_truth") is not None and self.config.get("send_ground_truth"):
