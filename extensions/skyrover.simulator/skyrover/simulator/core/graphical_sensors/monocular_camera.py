...
from skyrover.simulator.core.graphical_sensors import GraphicalSensor
...
class MonocularCamera(GraphicalSensor):
    ...
    def initialize(self, vehicle):
        ...
        self._stage_prim_path = get_stage_next_free_path(SkyRoverInterface().world.stage, self._vehicle.prim_path + "/body/" + self._camera_name, False)
