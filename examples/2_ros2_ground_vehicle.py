...
class GroundApp:
    ...
    def __init__(self):
        ...
        self.gr._world = World(**self.gr._world_settings)
        self.world = self.gr.world

        # Launch one of the worlds provided by NVIDIA
        self.gr.load_environment(SIMULATION_ENVIRONMENTS["Curved Gridroom"])
    ...
    def vehicle_factory(self, vehicle_id: int, gap_x_axis: float):
        ...
        config_ros2 = ROS2MultiRotorGroundBackendConfig()
        config_multirotor.backends = [
                        ROS2MultiRotorBackend(vehicle_id = vehicle_id, 
                            config=config_ros2)
            ]
        
        # ros2_backend_config = ROS2MultiRotorGroundBackendConfig()
    ...
    def run(self):
        ...
        # Cleanup and stop
        carb.log_warn("GroundApp Simulation App is closing.")
        self.timeline.stop()
